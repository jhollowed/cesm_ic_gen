...
!-----------------------------------------------------------------------
	...
	! if t_profile = 1, implement different temperature profile 
...
SUBROUTINE test3_gravity_wave_new (lon,lat,hyam,hybm,u,v,w,t,phis,ps,rho,q)
...
!	real(8), parameter :: 	X       = 125.d0,		&	! Reduced Earth reduction factor
	real(8), parameter :: 	X       = 1.d0,		        &	! Regulkar size Earth
			    	Om      = 0.d0,			&	! Rotation Rate of Earth
...
!----------------------------------------------------------------------- 
      real(r8),parameter :: u0      = 20.d0,                          &   ! 20 m/s
                            ...
                            h0      = 2000.d0,                        &   !  amplitude of the mountain, 4km
                            h1      = 4000.d0,                        &   !  amplitude of the mountain, 4km
!                            d0      = 1500.d3,                        &   !  half width 1500 km
                            d0      = 500.d3,                         &   !  half width 1000 km
                            d1      = 500.d3,                         &   !  half width 1000 km
                            lambda0 = 0.5d0*pi,                       &   !  center point in longitudes
                            lambda1 = (105.d0/180.d0)*pi,             &   !  center point in longitudes
                            dlambda0 = (8.d0/180.d0)*pi,              &   !  half width of ridge in longitude 
                            dlambda1 = dlambda0,                      &   !  half width of ridge 
...
!      phis = g*h0 * exp(-((lon-lambda0)/dlambda0)**2) ! Ridge profile of the mountain
...
!      phis = phis +  g*h1 * exp(-((lon-lambda1)/dlambda1)**2) ! Ridge profile of the mountain
